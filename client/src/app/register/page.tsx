...
const RegisterPage: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* left: form */}
      <div className="relative z-10 w-full md:w-5/12 flex flex-col items-center  min-h-screen px-6 pt-12 pb-32 space-y-8">
        {/* logo */}
        <div>
      ...
      {/* right: image */}
      <div className="hidden md:block md:w-7/12 md:m-4 relative">
        <Image
          src="/assets/tree.png"
          alt="Serene tree"
          fill
